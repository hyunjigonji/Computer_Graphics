...
def render():
    ...
    positionLightColor = (1.,2.,3.,1.)
    ambientLightColor = (.1,.1,.1,1.)
    diffuseLightColor = (1.,1.,1.,1.)
    specularLightColor = (1.,1.,1.,1.)
    glLightfv(GL_LIGHT0, GL_POSITION, positionLightColor)
...
def main():
    ...
    if not glfw.init():
        return
    window = glfw.create_window(480,480,'2017030191-10-1', None,None)
    if not window:
        glfw.terminate()
        return
